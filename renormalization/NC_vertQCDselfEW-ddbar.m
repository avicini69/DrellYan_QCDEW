...
inputvalues=maindir<>"NCDY/numerics/results/inputdata/grid-input-st.res";
Get[inputvalues];
fileborn=maindir<>"renormalization2022/NC_dD_Born.m";
Get[fileborn];
...
FILE=maindir<>"NCDY/numerics/inputschemes/dD-vertself-delta-"<>ToString[EWinputscheme]<>".dat";
...
Print["ciao ciao", 100000 Pigagalept1L /. mu2->91.1876^2 //. subconst];
Print[DeltaalphahadOpenLoops]


Collect[ctZZ1L/. flagZZmZ->1 /. myB0i[bb0,___] ->fdiveps /. divflag->-1/2 fdiveps //. subsymbols  , {fdiveps},Simplify  ]


Collect[ctAA1L /. myB0i[bb0,___] ->fdiveps /. divflag->-1/2 fdiveps //. subsymbols  , {fdiveps},Simplify  ]
