...
In the plot we can observe an excellent agreement between our result and the red crosses, that represent the value of the analytic result, evaluated with {\sc GiNaC} \cite{Bauer:2000cp,Vollinga:2004sn} for a few selected points.
    ...
    \centering
      ...
      \centering
       ...
       {\small \texttt{ExpansionOrder}} & \texttt{Integer} & 50 & {\small The maximum order in the kinematic variable at which the solution is expanded.}\\
        ...
        \hline
        {\small\texttt{ChopPrecision}} & \texttt{Integer} & 150 & {\small Replaces number which are smaller than $10^{-\texttt{ChopPrecision}}$ by exactly $0$ in internal computations.} \\
        \hline
