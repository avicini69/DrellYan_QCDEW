...
Get[inputvalues];
fileborn=maindir<>"NCDY/numerics/renormalization/NC_dD_Born.m";
Get[fileborn];
...
FILE=maindir<>"NCDY/numerics/renormalization/NC_numerics/dD-vertself-delta-"<>ToString[EWinputscheme]<>".dat";
